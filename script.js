document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!existingSuccess) {
        ...
        existingSuccess.className = 'form-success-message';
        existingSuccess.setAttribute('role', 'status');
        contactForm.appendChild(existingSuccess);
      }
  ...
  const animationElements = document.querySelectorAll(OBSERVED_SELECTORS);
...
(function(){
  ...
  function setupMarquee(){
    document.querySelectorAll('[data-marquee]').forEach(function(el){
      ...
      // Duplicate children to enable seamless infinite loop
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7200fe8d-fed6-4e1c-b369-bf87a1f6873e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7200fe8d-fed6-4e1c-b369-bf87a1f6873e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7200fe8d-fed6-4e1c-b369-bf87a1f6873e';
